...
/**
 * Pattern-specific match representation of the linroad.queries.carIsOnDownRamp pattern,
 * to be used in conjunction with {@link CarIsOnDownRampMatcher}.
 * 
...
public abstract class CarIsOnDownRampMatch extends BasePatternMatch {
  private Car fCar;
  ...
  private CarIsOnDownRampMatch(final Car pCar, final String pCarId) {
    this.fCar = pCar;
    this.fCarId = pCarId;
  }
  ...
  public List<String> parameterNames() {
    return CarIsOnDownRampMatch.parameterNames;
  }
  ...
  @Override
  public CarIsOnDownRampMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof CarIsOnDownRampMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    CarIsOnDownRampMatch other = (CarIsOnDownRampMatch) obj;
  ...
  @Override
  public CarIsOnDownRampQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static CarIsOnDownRampMatch newEmptyMatch() {
   ...
   * 
   */
  public static CarIsOnDownRampMatch newMutableMatch(final Car pCar, final String pCarId) {
   ...
   * 
   */
  public static CarIsOnDownRampMatch newMatch(final Car pCar, final String pCarId) {
    return new Immutable(pCar, pCarId);
  }
  
  private static final class Mutable extends CarIsOnDownRampMatch {
  ...
  private static final class Immutable extends CarIsOnDownRampMatch {
