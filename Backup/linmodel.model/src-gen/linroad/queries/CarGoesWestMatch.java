...
/**
 * Pattern-specific match representation of the linroad.queries.carGoesWest pattern,
 * to be used in conjunction with {@link CarGoesWestMatcher}.
 * 
...
public abstract class CarGoesWestMatch extends BasePatternMatch {
  private Car fCar;
  ...
  private CarGoesWestMatch(final Car pCar, final String pCarId) {
    this.fCar = pCar;
    this.fCarId = pCarId;
  }
  ...
  public List<String> parameterNames() {
    return CarGoesWestMatch.parameterNames;
  }
  ...
  @Override
  public CarGoesWestMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof CarGoesWestMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    CarGoesWestMatch other = (CarGoesWestMatch) obj;
  ...
  @Override
  public CarGoesWestQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static CarGoesWestMatch newEmptyMatch() {
   ...
   * 
   */
  public static CarGoesWestMatch newMutableMatch(final Car pCar, final String pCarId) {
   ...
   * 
   */
  public static CarGoesWestMatch newMatch(final Car pCar, final String pCarId) {
    return new Immutable(pCar, pCarId);
  }
  
  private static final class Mutable extends CarGoesWestMatch {
  ...
  private static final class Immutable extends CarGoesWestMatch {
