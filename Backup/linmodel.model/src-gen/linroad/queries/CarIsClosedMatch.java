...
/**
 * Pattern-specific match representation of the linroad.queries.carIsClosed pattern,
 * to be used in conjunction with {@link CarIsClosedMatcher}.
 * 
...
public abstract class CarIsClosedMatch extends BasePatternMatch {
  private Car fCar;
  ...
  private CarIsClosedMatch(final Car pCar, final String pCarId) {
    this.fCar = pCar;
    this.fCarId = pCarId;
  }
  ...
  public List<String> parameterNames() {
    return CarIsClosedMatch.parameterNames;
  }
  ...
  @Override
  public CarIsClosedMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof CarIsClosedMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    CarIsClosedMatch other = (CarIsClosedMatch) obj;
  ...
  @Override
  public CarIsClosedQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static CarIsClosedMatch newEmptyMatch() {
   ...
   * 
   */
  public static CarIsClosedMatch newMutableMatch(final Car pCar, final String pCarId) {
   ...
   * 
   */
  public static CarIsClosedMatch newMatch(final Car pCar, final String pCarId) {
    return new Immutable(pCar, pCarId);
  }
  
  private static final class Mutable extends CarIsClosedMatch {
  ...
  private static final class Immutable extends CarIsClosedMatch {
