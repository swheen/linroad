...
/**
 * Pattern-specific match representation of the linroad.queries.carIsOnUpRamp pattern,
 * to be used in conjunction with {@link CarIsOnUpRampMatcher}.
 * 
...
public abstract class CarIsOnUpRampMatch extends BasePatternMatch {
  private Car fCar;
  ...
  private CarIsOnUpRampMatch(final Car pCar, final String pCarId) {
    this.fCar = pCar;
    this.fCarId = pCarId;
  }
  ...
  public List<String> parameterNames() {
    return CarIsOnUpRampMatch.parameterNames;
  }
  ...
  @Override
  public CarIsOnUpRampMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof CarIsOnUpRampMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    CarIsOnUpRampMatch other = (CarIsOnUpRampMatch) obj;
  ...
  @Override
  public CarIsOnUpRampQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static CarIsOnUpRampMatch newEmptyMatch() {
   ...
   * 
   */
  public static CarIsOnUpRampMatch newMutableMatch(final Car pCar, final String pCarId) {
   ...
   * 
   */
  public static CarIsOnUpRampMatch newMatch(final Car pCar, final String pCarId) {
    return new Immutable(pCar, pCarId);
  }
  
  private static final class Mutable extends CarIsOnUpRampMatch {
  ...
  private static final class Immutable extends CarIsOnUpRampMatch {
