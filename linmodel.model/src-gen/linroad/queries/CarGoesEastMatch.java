...
/**
 * Pattern-specific match representation of the linroad.queries.carGoesEast pattern,
 * to be used in conjunction with {@link CarGoesEastMatcher}.
 * 
...
public abstract class CarGoesEastMatch extends BasePatternMatch {
  private Car fCar;
  ...
  private CarGoesEastMatch(final Car pCar, final String pCarId) {
    this.fCar = pCar;
    this.fCarId = pCarId;
  }
  ...
  public List<String> parameterNames() {
    return CarGoesEastMatch.parameterNames;
  }
  ...
  @Override
  public CarGoesEastMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof CarGoesEastMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    CarGoesEastMatch other = (CarGoesEastMatch) obj;
  ...
  @Override
  public CarGoesEastQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static CarGoesEastMatch newEmptyMatch() {
   ...
   * 
   */
  public static CarGoesEastMatch newMutableMatch(final Car pCar, final String pCarId) {
   ...
   * 
   */
  public static CarGoesEastMatch newMatch(final Car pCar, final String pCarId) {
    return new Immutable(pCar, pCarId);
  }
  
  private static final class Mutable extends CarGoesEastMatch {
  ...
  private static final class Immutable extends CarGoesEastMatch {
