...
/**
 * A match processor tailored for the linroad.queries.carIsOnDownRamp pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class CarIsOnDownRampProcessor implements IMatchProcessor<CarIsOnDownRampMatch> {
  /**
  ...
  @Override
  public void process(final CarIsOnDownRampMatch match) {
