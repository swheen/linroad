...
/**
 * A match processor tailored for the linroad.queries.carIsOpen pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class CarIsOpenProcessor implements IMatchProcessor<CarIsOpenMatch> {
  /**
  ...
  @Override
  public void process(final CarIsOpenMatch match) {
