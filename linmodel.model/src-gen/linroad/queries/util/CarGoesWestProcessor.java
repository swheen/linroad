...
/**
 * A match processor tailored for the linroad.queries.carGoesWest pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class CarGoesWestProcessor implements IMatchProcessor<CarGoesWestMatch> {
  /**
  ...
  @Override
  public void process(final CarGoesWestMatch match) {
