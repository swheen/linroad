...
/**
 * A match processor tailored for the linroad.queries.carIsClosed pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class CarIsClosedProcessor implements IMatchProcessor<CarIsClosedMatch> {
  /**
  ...
  @Override
  public void process(final CarIsClosedMatch match) {
